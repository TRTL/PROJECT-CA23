            ...
            modelBuilder.Entity("PROJECT_CA23.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            Created = new DateTime(2023, 1, 17, 2, 38, 25, 584, DateTimeKind.Local).AddTicks(2689),
                            FirstName = "Jonas",
                            LastName = "Jonaitis",
                            PasswordHash = new byte[] { 140, 177, 187, 97, 172, 41, 122, 194, 55, 144, 77, 242, 191, 178, 90, 30, 83, 98, 82, 86, 152, 120, 94, 183, 71, 131, 188, 69, 178, 56, 184, 67 },
                            PasswordSalt = new byte[] { 95, 200, 68, 175, 113, 102, 186, 4, 68, 116, 1, 242, 127, 163, 188, 62, 177, 108, 91, 154, 232, 152, 251, 167, 45, 27, 226, 26, 34, 166, 171, 211, 135, 158, 232, 159, 223, 162, 117, 99, 125, 96, 55, 0, 139, 51, 234, 113, 58, 232, 156, 103, 13, 178, 192, 143, 153, 172, 158, 221, 10, 99, 113, 93 },
                            Role = "admin",
                            Updated = new DateTime(2023, 1, 17, 2, 38, 25, 587, DateTimeKind.Local).AddTicks(3163),
                            Username = "admin"
                        });
                });
