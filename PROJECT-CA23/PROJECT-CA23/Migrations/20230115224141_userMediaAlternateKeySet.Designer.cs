...
namespace PROJECTCA23.Migrations
{
    ...
    [Migration("20230115224141_userMediaAlternateKeySet")]
    partial class userMediaAlternateKeySet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PROJECT_CA23.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            Created = new DateTime(2023, 1, 16, 0, 41, 40, 888, DateTimeKind.Local).AddTicks(6276),
                            FirstName = "Jonas",
                            IsDeleted = false,
                            LastLogin = new DateTime(2023, 1, 16, 0, 41, 40, 892, DateTimeKind.Local).AddTicks(1041),
                            LastName = "Jonaitis",
                            PasswordHash = new byte[] { 157, 126, 217, 89, 172, 17, 105, 10, 94, 246, 184, 114, 177, 144, 163, 10, 244, 136, 118, 200, 140, 185, 107, 39, 128, 16, 52, 140, 153, 54, 127, 16 },
                            PasswordSalt = new byte[] { 61, 205, 183, 105, 25, 244, 230, 155, 169, 255, 112, 168, 98, 234, 158, 203, 130, 126, 199, 206, 75, 29, 220, 173, 74, 245, 190, 150, 157, 240, 73, 85, 138, 133, 17, 58, 249, 31, 45, 186, 5, 223, 184, 104, 147, 85, 60, 57, 228, 49, 138, 130, 16, 44, 31, 12, 230, 183, 45, 201, 141, 99, 106, 130 },
                            Role = "admin",
                            Updated = new DateTime(2023, 1, 16, 0, 41, 40, 892, DateTimeKind.Local).AddTicks(602),
                            Username = "admin"
                        });
                });
